...
from Byte-VC-Bot.helpers.decorators import authorized_users_only

from Byte-VC-Bot.helpers.decorators import skip_current_song, skip_item

from Byte-VC-Bot.helpers.decorators import QUEUE, clear_queue
...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            ...
            await m.reply("**🙄There's nothing in the queue to skips**")
